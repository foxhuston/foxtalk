...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("src/26_shader_textures.vert.bin");
        auto fragShaderCode = readFile("src/26_shader_textures.frag.bin");
    ...
    void setupCameraTexture() {
      ...
      createBuffer(imageSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, cameraBuffer, cameraBufferMemory);
    ...
    void updateCameraTexture() {
      ...
      // Write camera data
      void* data;
      vkMapMemory(device, cameraBufferMemory, 0, imageSize, 0, &data);
    ...
    /*void createTextureImage() {
        ...
        texWidth = cameraFrame.cols;
        texHeight = cameraFrame.rows;
        texChannels = cameraFrame.channels();
        ...
        std::cout << "Captured camera frame with w = " << texWidth << ", h = " << texHeight << ", #channels = " << texChannels << std::endl;
